...
public class SliderControls {
  ...
  /**
   * Basic getter method that returns the value from the Slider determining the speed of the
   * simulation
   *
  ...
  /**
   * Basic getter method that returns the value from the Slider determining the number of frames to
   * skip ahead
   *
  ...
  private void renderFooter() {
    ...
    frameSpeed = addAndReturnSlider(MIN_FRAME_SPEED, MAX_FRAME_SPEED, DEFAULT_FRAME_SPEED,
        allSliders);
