...
/**
 * GraphView creates a new window in the Simulation Application that displays the Stats of a Current
 * Simulation The graph is a line graph that shows the count of each state in the given simulation
 * at its current instance updateGraph() is called after the grid is updated in CAController
 *
 * @author Eric Doppelt
 */
...
public class GraphView {
   ...
   * Creates a LineChart in a new Window that displays the count of each state for a simulation at
   * its instance
   *
   ...
   * @param parent is the stage in CAController which is the parent stage of any given GraphView's
   *               window
   */
  ...
  /**
   * Adds a new set of data points to the GraphView Does not change the graph if time is less than
   * 0
   *
