...
/**
 * SimulationView encapsulates a StatView and GridView object to create a representation of a simulation
 * StatView is stacked on top of a GridView via a VBox which is dynamic and fills the size of the screen
 * Dependent on StatView and GridView class
 * @author Eric Doppelt
 */
public class SimulationView {
    ...
    /**
     * Constructor for a SimulationView that creates the VBox and adds the StatView and GridView to it
     ...
     * @param stats are the current count of each state in the simulation displayed to the user in the StatView
     */
    ...
    /**
     * Getter method to return the VBox holding the StatView and GridView
     * Called in CAController
    ...
    /**
     * Setter method to create the visual representation of the Grid
     * Calls updateGridView in GridView to update the GridPane
     * Calls .updateStats in StatView to display the current count for each type of state
